...
const Insurance = () => {
  return (
    <div>
        <div className='flex flex-col lg:flex-row w-[93%] justify-center items-center text-center insurance container gap-12 '>
