...
const Premium = () => {
  ...
  return (
    <div className="p-6 md:p-10 container w-[93%] h-auto xl:h-[790px] flex flex-col items-center justify-center  premium-section">
      <h2
      ...
      <div
        className="flex gap-12 premium-flex"
        style={{ paddingBottom: "1.5rem" }}
      >
        <div className="flex-1">
          <p
            className=" text-[#282828]  font-bold mb-4"
            style={{ fontSize: "18px" }}
          >
          ...
          <div className="space-y-6 mb-10">
            <div className="flex items-start gap-3">
              ...
              <p
                className="text-[#282828] general-text"
                style={{ paddingBottom: "12px", }}
              >
                <span className="font-medium  ">
                  Third-party liability premium
                </span>{" "}
                this is stipulated by the Insurance Regulatory and Development
                Authority of India (IRDAI), and it is directly proportional to
                your cars cubic capacity.
              </p>
            </div>
            ...
            <div
              ...
              style={{ paddingLeft: "25px", paddingBottom: "12px" }}
            >
              <table className="w-full mt-4 border border-gray-200 rounded-md overflow-hidden general-text">
                <thead className="bg-gray-100 text-left overflow-x-auto">
                  <tr>
                    <th
                    ...
                    >
                      ...
                      <br className="hidden md:block" /> 1st June 2022 (₹)
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {tableData.map((row, i) => (
                    <tr
                      key={i}
                      className="border-b-2 border-gray-200 text-[#282828]"
                    >
                      <td
                        style={{ paddingInline: "10px", paddingBlock: "10px" }}
                      >
          ...
          {factors.map((factor, index) => (
            <div key={index} className="flex items-start gap-3">
              ...
              <div>
                ...
                <p
                  className="general-text text-gray-700"
                  style={{
                    marginBottom: "0.5rem",
                    paddingBottom: "12px",
                    fontSize: "16px",
