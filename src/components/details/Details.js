...
const Details = () => {
  return (
    <div className='text-center details bg-[#F8F6F6] py-10'>
      <h1 className='text-4xl heading-details mb-2' style={{paddingTop : "2rem"}}>Why our customers love us?</h1>
      <p className='text-sm mb-6'>And, we think you will too.</p>
